    ...
    public ModelAndView report2(@RequestParam String districtNumber, @RequestParam String fiscalYear, HttpServletRequest request) {
        ...
        try {
            ...
            if (form.getValid()) {
                ...
                paymnetWorkSheet.getCalculations().add(new PaymentWorkSheetCalculation("1. Number of pupils", form.getPupilTran(), DEFAULT_INT_FORMAT));
                ...
                paymnetWorkSheet.getCalculations().add(new PaymentWorkSheetCalculation(messageSource.getMessage("Jasper.Report.PaymentWorksheet.netOperatingExpendures", null, Locale.US), form.getNetCurrentOperExpend(), DEFAULT_INT_FORMAT));
                ...
                paymnetWorkSheet.getCalculations().add(new PaymentWorkSheetCalculation(messageSource.getMessage("Jasper.Report.PaymentWorksheet.finalReimbursementProrated", null, Locale.US), form.getFinalReimEntitlement(), DEFAULT_MONEY_FORMAT));
                paymnetWorkSheet.getCalculations().add(new PaymentWorkSheetCalculation(messageSource.getMessage("Jasper.Report.PaymentWorksheet.advanceReimbursement2", null, Locale.US), form.getFinalReimEntitlement(), DEFAULT_MONEY_FORMAT));
                paymnetWorkSheet.getCalculations().add(new PaymentWorkSheetCalculation(messageSource.getMessage("Jasper.Report.PaymentWorksheet.additionalReimursements", null, Locale.US), form.getFinalReimProrated(), DEFAULT_MONEY_FORMAT));
                paymnetWorkSheet.getCalculations().add(new PaymentWorkSheetCalculation(messageSource.getMessage("Jasper.Report.PaymentWorksheet.actualMilesTraveled", null, Locale.US), form.getAdvPay(), DEFAULT_MONEY_FORMAT));
                paymnetWorkSheet.getCalculations().add(new PaymentWorkSheetCalculation(messageSource.getMessage("Jasper.Report.PaymentWorksheet.totalActualMilesTraveled", null, Locale.US), form.getDesegReim(), DEFAULT_MONEY_FORMAT));
