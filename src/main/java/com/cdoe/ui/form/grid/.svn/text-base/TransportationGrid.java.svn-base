 ...
 */
public class TransportationGrid {
	...
	private String districtNameAndNumber;

	public String getDistrictNameAndNumber() {
		return districtNameAndNumber;
	}

	public void setDistrictNameAndNumber(String districtNameAndNumber) {
		this.districtNameAndNumber = districtNameAndNumber;
	}
