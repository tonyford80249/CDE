 ...
 */
public class AuditSasidExceptionForm {
	...
	private List<AuditSasidExceptionGrid> auditSasidExceptionGridList = new ArrayList<AuditSasidExceptionGrid>();
	
	public List<AuditSasidExceptionGrid> getAuditSasidExceptionGridList() {
	    return this.auditSasidExceptionGridList;
	}
