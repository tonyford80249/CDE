...
@Controller
@RequestMapping("/secure/AudTracking")
public class AudTrackingController {

	private static final Logger logger = Logger.getLogger(AudTrackingController.class);
