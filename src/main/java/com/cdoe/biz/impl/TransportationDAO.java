...
public class TransportationDAO extends HibernateDAO implements
		ITransportationDAO {

	private static final Logger logger = Logger
			.getLogger(TransportationDAO.class);

	public List<Transportation> getByDistrictAndYear(final String districtNos,
	...
	public int updateCapOutTran(final String districtNos,
			final String fiscalYear, double capitalOutlayTotal) {
		// TODO Auto-generated method stub
		Session session = getCurrentSession();

		String hql = "UPDATE Transportation set capOutTran = :capOutTran "
		...
		query.setParameter("capOutTran", capitalOutlayTotal);
