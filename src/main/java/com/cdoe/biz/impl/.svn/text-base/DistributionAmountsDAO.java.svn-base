...
public class DistributionAmountsDAO extends HibernateDAO implements
	...
	public List<Prorate> getByFiscalYear(final String fiscalYear) {
		return getHibernateTemplate().findByNamedParam("FROM Prorate c WHERE c.fiscalYear = :fiscalYear", "fiscalYear", fiscalYear);
	}
