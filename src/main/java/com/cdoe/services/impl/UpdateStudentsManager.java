...
import com.cdoe.biz.impl.UpdateStudentsDAO;
import com.cdoe.biz.model.AuditSasidException;
import com.cdoe.services.IUpdateStudentsManager;
import com.cdoe.ui.form.AuditSasidExceptionForm;

public class UpdateStudentsManager extends BaseManager implements IUpdateStudentsManager {

	private static final Logger logger = Logger.getLogger(UpdateStudentsManager.class);
	
	private UpdateStudentsDAO updateStudentsDAO;
	...
	public void setUpdateStudentsDAO(UpdateStudentsDAO updateStudentsDAO) {
		this.updateStudentsDAO = updateStudentsDAO;
	}
