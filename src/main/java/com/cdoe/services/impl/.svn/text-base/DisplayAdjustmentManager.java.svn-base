...
import com.cdoe.biz.IDisplayAdjustmentDAO;
...
public class DisplayAdjustmentManager extends BaseManager implements IDisplayAdjustmentManager {
	...
	public void setDisplayAdjustmentDAO(IDisplayAdjustmentDAO displayAdjustmentDAO) {
		this.displayAdjustmentDAO = displayAdjustmentDAO;
	}
