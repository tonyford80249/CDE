...
public class AuditSummaryManager extends BaseManager implements IAuditSummaryManager {

	private static final Logger logger = Logger.getLogger(AuditSummaryManager.class);
