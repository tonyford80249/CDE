...
public class AudSumUpdateManager extends BaseManager implements IAudSumUpdateManager {

	private static final Logger logger = Logger.getLogger(AudSumUpdateManager.class);
