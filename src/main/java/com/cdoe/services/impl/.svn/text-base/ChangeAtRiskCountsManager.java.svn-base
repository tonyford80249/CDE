...
public class ChangeAtRiskCountsManager extends BaseManager implements IChangeAtRiskCountsManager {

	private static final Logger logger = Logger.getLogger(ChangeAtRiskCountsManager.class);
	
	private IChangeAtRiskCountsDAO changeAtRiskCountsDAO;
	...
	public AuditEqualForm setupForm(long id) {
		...
		form.setAssessedVal(String.valueOf(obj.getAssessedVal()));
		form.setCatVoced(String.valueOf(obj.getCatVoced()));
		form.setCatElpa(String.valueOf(obj.getCatElpa()));
		form.setFreeLunch18(String.valueOf(obj.getFreeLunch18()));
		form.setFreeLunchK12(String.valueOf(obj.getFreeLunchK12()));
		form.setMember18(String.valueOf(obj.getMember18()));
		form.setPropertyTax(String.valueOf(obj.getPropertyTax()));
		form.setMillLevyAdj(String.valueOf(obj.getMillLevyAdj()));
		form.setMonthEntitle(String.valueOf(obj.getMonthEntitle()));
		form.setYtdEntitle(String.valueOf(obj.getYtdEntitle()));
		form.setMonthPayment(String.valueOf(obj.getMonthPayment()));
		form.setYtdPayment(String.valueOf(obj.getYtdPayment()));
		form.setAllowSpend(String.valueOf(obj.getAllowSpend()));
		form.setCatLevyAdj(String.valueOf(obj.getCatLevyAdj()));
		form.setEslCsap(String.valueOf(obj.getEslCsap()));
		form.setFiscalYear(String.valueOf(obj.getFiscalYear()));
		return form;
	}
	
	public void setChangeAtRiskCountsDAO(IChangeAtRiskCountsDAO changeAtRiskCountsDAO) {
		this.changeAtRiskCountsDAO = changeAtRiskCountsDAO;
	}
