...
import com.cdoe.services.IImportAuditTransDataManager;
import com.cdoe.biz.IImportAuditTransDataDAO;
import com.cdoe.biz.model.*;
import com.cdoe.ui.form.TransportationForm;

public class ImportAuditTransDataManager extends BaseManager implements IImportAuditTransDataManager {

	private static final Logger logger = Logger.getLogger(ImportAuditTransDataManager.class);
	
	private IImportAuditTransDataDAO importAuditTransDataDAO;
	...
	public void setImportAuditTransDataDAO(IImportAuditTransDataDAO importAuditTransDataDAO) {
		this.importAuditTransDataDAO = importAuditTransDataDAO;
	}
