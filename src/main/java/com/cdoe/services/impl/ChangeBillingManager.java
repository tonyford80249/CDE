...
import com.cdoe.biz.IChangeBillingDAO;
import com.cdoe.biz.model.*;
import com.cdoe.ui.form.AuditEqualForm;

public class ChangeBillingManager extends BaseManager implements IChangeBillingManager {

	private static final Logger logger = Logger.getLogger(ChangeBillingManager.class);
	
	private IChangeBillingDAO changeBillingDAO;
	...
	public void setChangeBillingDAO(IChangeBillingDAO changeBillingDAO) {
		this.changeBillingDAO = changeBillingDAO;
	}
