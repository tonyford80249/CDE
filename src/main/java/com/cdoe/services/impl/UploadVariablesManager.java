...
import com.cdoe.biz.IUploadVariablesDAO;
import com.cdoe.biz.model.*;
import com.cdoe.ui.form.StateEqualForm;

public class UploadVariablesManager extends BaseManager implements IUploadVariablesManager {

	private static final Logger logger = Logger.getLogger(UploadVariablesManager.class);
	
	private IUploadVariablesDAO uploadVariablesDAO;
	...
	public void setUploadVariablesDAO(IUploadVariablesDAO uploadVariablesDAO) {
		this.uploadVariablesDAO = uploadVariablesDAO;
	}
