...
import com.cdoe.biz.ICreateAuditDAO;
import com.cdoe.biz.model.*;
import com.cdoe.ui.form.AuditEqualForm;

public class CreateAuditManager extends BaseManager implements ICreateAuditManager {

	private static final Logger logger = Logger.getLogger(CreateAuditManager.class);
	
	private ICreateAuditDAO createAuditDAO;
	...
	public void setCreateAuditDAO(ICreateAuditDAO createAuditDAO) {
		this.createAuditDAO = createAuditDAO;
	}
