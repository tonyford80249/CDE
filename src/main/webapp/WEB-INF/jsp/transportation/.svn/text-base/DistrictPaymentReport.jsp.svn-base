					...
					<TABLE>
						<TR>
							<TD ALIGN="right"><LABEL FOR=""><spring:message
										code="DistrictPaymentReport.StaticText.$1StDistributionStaticText" /></LABEL>
							</TD>
							<TD><form:input id="" path="totalFirstPayment"
									readOnly="true" /></TD>
							<TD ALIGN="right"><LABEL FOR=""><spring:message
										code="DistrictPaymentReport.StaticText.$2NdDistributionStaticText" /></LABEL>
							</TD>
						...
						<TR>
							<TD ALIGN="right"><LABEL FOR="FirstProration"><spring:message
										code="DistrictPaymentReport.StaticText.$1StProrationStaticText" /></LABEL>
							</TD>
							<TD><form:input id="FirstProration"
									path="prorateFactor1stPayment" readOnly="true" /></TD>
							<TD ALIGN="right"><LABEL FOR="SecondProration"><spring:message
										code="DistrictPaymentReport.StaticText.$2NdProrationStaticText" /></LABEL>
							</TD>
